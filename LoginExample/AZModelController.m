...
@interface AZModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation AZModelController
...
{   
    ...
    AZDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"AZDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(AZDataViewController *)viewController];
